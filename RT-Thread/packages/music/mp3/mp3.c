...
** Descriptions:        mp3解码功能初始化
** input parameters:    decoder: mp3解码基本结构
** output parameters:   NONE
** Returned value:      NONE
*********************************************************************************************************/
...
** Descriptions:        创建mp3解码结构，并初始化
** input parameters:    NONE
** output parameters:   NONE
** Returned value:     创建的mp3_decoder
*********************************************************************************************************/
...
** Descriptions:        mp3解码，同时将解码后的wav数据送入声卡
** input parameters:    decoder: mp3解码基本结构
** output parameters:   NONE
** Returned value:      NONE
*********************************************************************************************************/
...
** Descriptions:        读取mp3音频文件数据
** input parameters:    parameter: 文件指针，也可以是缓冲区指针
**                      buffer:    数据读取缓冲区
**                      length:    读取数据长度 
** output parameters:   NONE
...
/*********************************************************************************************************
** Function name:       mp3
** Descriptions:        mp3音乐播放函数
** input parameters:    filename: 播放的MP3文件名
** output parameters:   NONE
** Returned value:      NONE
*********************************************************************************************************/
