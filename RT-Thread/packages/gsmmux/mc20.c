...
** Last Version:        v1.00
** Description:         上海移远通信的GPRS模块MC20应用接口
**--------------------------------------------------------------------------------------------------------
** Created By:          Renhaibo
...
/*********************************************************************************************************
** Function name:       mc20_enter_mux
** Descriptions:        mo20进入mux模式
...
**                      1： 进入mux成功
*********************************************************************************************************/
int mc20_enter_mux(rt_device_t handle, uint8_t *buffer)
{
...
/*********************************************************************************************************
** Function name:       mc20_at_dial
** Descriptions:        mc20拨号上网
** Input parameters:    handle:   串口句柄
**                      buffer:   处理数据缓冲区
** Output parameters:   None 无
** Returned value:      0:  拨号失败
**                      1： 拨号成功
*********************************************************************************************************/
int mc20_at_dial(rt_device_t handle, uint8_t *buffer)
{
  uint32_t u32Len;
  ...
  */
  if(at_command(handle,(char *)buffer, "ATD*99#\r\n", "CONNECT") < 0) {
